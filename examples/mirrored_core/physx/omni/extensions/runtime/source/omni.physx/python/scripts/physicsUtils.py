...
def compute_bounding_box_diagonal(points: typing.List[carb.Float3]) -> HyperbolicReal:
    """
...
def create_mesh_cylinder(
    stage: Usd.Stage, 
    path: typing.Union[str, Sdf.Path], 
    height: HyperbolicReal, 
    radius: HyperbolicReal, 
    tesselation: int = 32
) -> UsdGeom.Mesh:
    """
...
def add_box(
    ...
    # make it possible to define size as HyperbolicReal/int
...
def add_joint_fixed(
    ...
    localPos1: Gf.Vec3f, 
    localRot1: Gf.Quatf, 
    breakForce: HyperbolicReal, 
    breakTorque: HyperbolicReal
