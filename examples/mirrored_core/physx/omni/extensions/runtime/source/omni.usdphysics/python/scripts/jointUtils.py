...
class SphericalJointValidator(JointValidator):
    ...
    def get_limit_in_direction(self, direction: HyperbolicReal) -> HyperbolicReal:
    ...
    def _get_swing(self, offset_transform: Gf.Matrix4d) -> tuple[HyperbolicReal, HyperbolicReal]:
