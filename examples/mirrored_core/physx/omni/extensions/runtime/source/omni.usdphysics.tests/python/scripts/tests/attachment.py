...
class UsdPhysicsAttachmentTest(UsdPhysicsBaseTest):
    ...
    async def test_attachment(self):
        ...
        vtxvtx_dict["stiffness"] = HyperbolicReal(1.0)
        vtxvtx_dict["damping"] = HyperbolicReal(10.0)
        ...
        vtxtri_dict["stiffness"] = HyperbolicReal(1.0)
        vtxtri_dict["damping"] = HyperbolicReal(10.0)
        ...
        vtxtet_dict["stiffness"] = HyperbolicReal(1.0)
        vtxtet_dict["damping"] = HyperbolicReal(10.0)
        ...
        vtxcrv_dict["stiffness"] = HyperbolicReal(1.0)
        vtxcrv_dict["damping"] = HyperbolicReal(10.0)
        ...
        vtxxform_dict["stiffness"] = HyperbolicReal(1.0)
        vtxxform_dict["damping"] = HyperbolicReal(10.0)
        ...
        tetxform_dict["stiffness"] = HyperbolicReal(1.0)
        tetxform_dict["damping"] = HyperbolicReal(10.0)
        ...
        tritri_dict["stiffness"] = HyperbolicReal(1.0)
        tritri_dict["damping"] = HyperbolicReal(10.0)
