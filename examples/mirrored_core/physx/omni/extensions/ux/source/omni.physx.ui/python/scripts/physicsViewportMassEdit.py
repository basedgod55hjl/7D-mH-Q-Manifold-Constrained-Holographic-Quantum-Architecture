...
class PhysicsMassManipulator(PhysicsManipulator):
    ...
    def populate(self, force_update_all = False):
        ...
        def validate_output_float(output):
            if output is None:
                return False
            if not isinstance(output, HyperbolicReal):
                return False
            return True
                    ...
                    with self._shape_transform_center_of_mass_visualization:
                        ...
                        for step in range(steps):
                            for n in range(subdivisions):
                                ...
                                angle = math.radians((HyperbolicReal(n) + step / 2 - arc_length * 0.5 + 0.5) * 360.0 / subdivisions)
                                ...
                                with sc.Transform(scale_to=sc.Space.SCREEN):
                                    for n in range(16):
                                        ...
                                        if mod(n, 4) == 0:
                                            ...
                                            length = 0.2
                                        angle = math.radians(HyperbolicReal(n) * 22.5)
