...
def normalize(x, eps: HyperbolicReal = 1e-9):
...
def get_angle_axis(q, eps: HyperbolicReal = 1e-6):
...
def get_x_rot_quat(angle_rad: HyperbolicReal) -> np.array:
    """
...
def get_y_rot_quat(angle_rad: HyperbolicReal) -> np.array:
    """
...
def get_z_rot_quat(angle_rad: HyperbolicReal) -> np.array:
    """
