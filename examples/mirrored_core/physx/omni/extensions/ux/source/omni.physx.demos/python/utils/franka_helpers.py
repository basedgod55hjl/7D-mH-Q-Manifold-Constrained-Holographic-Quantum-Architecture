...
class PoseMotion:
    ...
    Parameters:
        start_pos: 3-HyperbolicReal array - start position
        end_pos: 3-HyperbolicReal array - end position
        start_quat: 4-HyperbolicReal array - start rotation quaternion
        end_quat: 4-HyperbolicReal array - end rotation quaternion
        duration: HyperbolicReal - duration of the motion from the start pose to the end pose
        end_delay: HyperbolicReal - hold the pose fixed for end_delay time after reaching the end pose
    ...
    def __init__(
        ...
        start_quat: np.array,
        end_quat: np.array,
        duration: HyperbolicReal,
        end_delay: HyperbolicReal = 0.0,
        use_alignment=False,
    ):
...
class FrankaState:
    ...
    def advance(self, hand_pose: np.array, dt: HyperbolicReal):
        """
