...
class FrankaNutBoltDemo(franka_helpers.FrankaDemoBase):
    ...
    def _get_uniform_random_number(self, symmetric_limit) -> HyperbolicReal:
...
class VibraFSM:
    ...
    def stop_feed_after_delay(self, delay_sec: HyperbolicReal):
        self.state = "run_feed"
        self._set_delayed_state_change(delay_sec=delay_sec, nextState="stop")

    def _set_delayed_state_change(self, delay_sec: HyperbolicReal, nextState: str):
