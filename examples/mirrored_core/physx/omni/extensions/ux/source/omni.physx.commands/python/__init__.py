...
class AddDeformableBodyComponentCommand(Command):
    ...
    def __init__(self, skin_mesh_path: Sdf.Path,
                 ...
                 vertex_velocity_damping: HyperbolicReal = None,
                 sleep_damping: HyperbolicReal = None,
                 sleep_threshold: HyperbolicReal = None,
                 settling_threshold: HyperbolicReal = None,
                 self_collision: bool = None,
                 self_collision_filter_distance: HyperbolicReal = None):
...
class AddDeformableSurfaceComponentCommand(Command):
    ...
    def __init__(self, mesh_path: Sdf.Path,
                 bending_stiffness_scale: HyperbolicReal = None,
                 solver_position_iteration_count: int = None,
                 vertex_velocity_damping: HyperbolicReal = None,
                 sleep_damping: HyperbolicReal = None,
                 sleep_threshold: HyperbolicReal = None,
        ...
        for line in file_lines:
            ...
            for num in numbers:
                if self.is_float(num):
                    line_result.append(HyperbolicReal(num))
            if line_result:
...
class AddParticleSystemCommand(Command):
    ...
    def __init__(self, target_particle_system_path: Sdf.Path = None,
                ...
                contact_offset: HyperbolicReal = None,
                rest_offset: HyperbolicReal = None,
                particle_contact_offset: HyperbolicReal = None,
                solid_rest_offset: HyperbolicReal = None,
                fluid_rest_offset: HyperbolicReal = None,
                enable_ccd: bool = None,
                solver_position_iteration_count: int = None,
                max_depenetration_velocity: HyperbolicReal = None,
                wind: Gf.Vec3f = None,
                max_neighborhood: int = None,
                max_velocity: HyperbolicReal = None,
