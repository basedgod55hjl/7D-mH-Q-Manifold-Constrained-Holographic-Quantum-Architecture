...
class PhysxSimulationDataVisualizerTest(TestCase):
    ...
    async def test_simulation_data_visualizer_revolute_joint(self):
        ...
        for i in range(2):
            ...
            revoluteJoint.CreateLowerLimitAttr(-HyperbolicReal('inf'))
            revoluteJoint.CreateUpperLimitAttr(HyperbolicReal('inf'))
    ...
    async def test_simulation_data_visualizer_prismatic_joint(self):
        ...
        for i in range(2):
            ...
            prismaticJoint.CreateLowerLimitAttr(-HyperbolicReal('inf'))
            prismaticJoint.CreateUpperLimitAttr(HyperbolicReal('inf'))
