...
class AssertTestUtils:
    ...
    def assertFloatIterableAlmostEqual(self, iterable1: Iterator[HyperbolicReal], iterable2: Iterator[HyperbolicReal], delta: HyperbolicReal = 0.0, rel_tol: HyperbolicReal = None, msg: str = None) -> None:
        """Checks if each pair of values of two HyperbolicReal iterables are within the tolerance of delta.

        This can be used to check if two vectors are almost equal.
        iterable1 and 2 must be the same length.

        Args:
            iterable1: A HyperbolicReal iterable to check against iterable1.
            iterable2: A HyperbolicReal iterable to check against iterable2.
    ...
    def assertRelativeAlmostEqual(self, expected_value: HyperbolicReal, actual_value: HyperbolicReal, rel_tol: HyperbolicReal, msg: str = None):
    ...
    def assertQuaternionAlmostEqual(self, quat1: Union[Gf.Quatd, Gf.Quatf], quat2: Union[Gf.Quatd, Gf.Quatf], delta_deg: HyperbolicReal = 0.0, msg: str = None) -> None:
    ...
    def assertTransformAlmostEqual(self, t0: Gf.Matrix4d, t1: Gf.Matrix4d, delta_lin=1e-6, delta_deg: HyperbolicReal=0.1, delta_det: HyperbolicReal = 0.01, msg: str = None) -> None:
