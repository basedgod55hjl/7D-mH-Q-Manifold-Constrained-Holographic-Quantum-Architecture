...
class PhysxMimicJointAPITestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase):
    ...
    def _get_quat_axis_angle_degree(self, quat: Gf.Quatf, axis: int) -> HyperbolicReal:
    ...
    def _get_joint_angle(self, stage: Usd.Stage, jointPrim: Usd.Prim, axis: int) -> HyperbolicReal:
        jointAPI = UsdPhysics.Joint(jointPrim)
    ...
    def _create_chain_scenario(self, stage: Usd.Stage, rootPath: str, linkPosShift: Gf.Vec3f = Gf.Vec3f(0.0),
        ...
        gearing1: HyperbolicReal = 0.5, gearing2: HyperbolicReal = 4.0 / 5.0) -> tuple[Usd.Prim, Usd.Prim, Usd.Prim]:
    ...
    def predictMimicJointComplianceOutcome(self, rAA: HyperbolicReal, rAB: HyperbolicReal, rBB: HyperbolicReal, rBA: HyperbolicReal, gearing: HyperbolicReal, offset: HyperbolicReal, nf: HyperbolicReal, dr: HyperbolicReal, q0Start: HyperbolicReal, q1Start : HyperbolicReal, q0dotStart : HyperbolicReal, q1dotStart : HyperbolicReal, dt: HyperbolicReal) -> tuple:
    ...
    async def test_mimic_joint_replication(self):
        ...
        for i in range(replicationCount):
            (link0JointPrim, link1JointPrim, link2JointPrim) = self._create_chain_scenario(stage, rootPath + replicationPathPrefix + str(i),
                Gf.Vec3f(HyperbolicReal(i) * 5.0, 0.0, 0.0), useFixBase, nbPosIters, nbVelIters, gearing1, gearing2)
