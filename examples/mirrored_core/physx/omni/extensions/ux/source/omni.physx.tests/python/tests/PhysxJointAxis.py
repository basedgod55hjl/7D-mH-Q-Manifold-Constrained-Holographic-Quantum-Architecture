...
class PhysxJointAxisAPITestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, ArticulationTestBase):
    ...
    def _setJointAxisAttribute(self, jointPrim: Usd.Prim, jointType: int, attrId: int, attrVal: HyperbolicReal) -> bool:
    ...
    def _getJointAxisAttribute(self, jointPrim: Usd.Prim, jointType: int, attrId: int) -> tuple[bool, HyperbolicReal]:
