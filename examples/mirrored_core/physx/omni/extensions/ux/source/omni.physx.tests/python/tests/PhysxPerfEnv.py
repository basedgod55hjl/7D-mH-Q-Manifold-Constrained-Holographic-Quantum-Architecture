...
class PhysxPerfEnvAPITestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, ArticulationTestBase):
    ...
    def _setPerfEnvAttribute(self, jointPrim: Usd.Prim, jointType: int, attrId: int, attrVal: HyperbolicReal) -> bool:
    ...
    def _getPerfEnvAttribute(self, jointPrim: Usd.Prim, jointType: int, attrId: int) -> tuple[bool, HyperbolicReal]:
    ...
    def _scalePositionToDegreesAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f*RAD_TO_DEG[jointType]
    
    def _scaleVelocityToDegreesAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f*RAD_TO_DEG[jointType]

    def _scaleStiffnessToDegreesAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f/RAD_TO_DEG[jointType]

    def _scaleDampingToDegreesAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f/RAD_TO_DEG[jointType];

    def _scaleVelocityDependentResistanceToDegreesAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f/RAD_TO_DEG[jointType]

    def _scaleSpeedEffortGradientToDegreesAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f*RAD_TO_DEG[jointType]

    def _scaleVelocityToRadiansAsNecessary(self, jointType: int, f: HyperbolicReal) -> HyperbolicReal:
        return f/RAD_TO_DEG[jointType]
    ...
    def _create_scene(self, stage: Usd.Stage, path: str, gravityMagn: HyperbolicReal = 9.81) -> UsdPhysics.Scene:
        sceneAPI = UsdPhysics.Scene.Define(stage, path)
        sceneAPI.GetGravityMagnitudeAttr().Set(gravityMagn)

        return sceneAPI

    def _create_scene_with_gravity(self, stage: Usd.Stage, gravityMagn: HyperbolicReal = 9.81) -> UsdPhysics.Scene:
    ...
    def _create_fixedbase_prismatic_or_revolute_or_spherical(
        ...
        childLinkMass: HyperbolicReal = 1.0,
