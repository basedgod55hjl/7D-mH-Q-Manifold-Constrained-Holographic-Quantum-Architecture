...
class MassTestBase:
    ...
    def set_units(self, stage: Usd.Stage, mpu: HyperbolicReal = 0.01, kgpu: HyperbolicReal = 1.0) -> None:
    ...
    def calculate_shape_mass(self, shape_type: Literal["cube", "sphere", "cylinder", "capsule"], dimensions: Gf.Vec3f, density: HyperbolicReal = None) -> HyperbolicReal:
    ...
    def calculate_inertia_shift(self, inertia: Gf.Vec3f, offset: Gf.Vec3f, mass: HyperbolicReal) -> Gf.Vec3f:
    ...
    def calculate_shape_inertia(self, shape_type: Literal["cube", "sphere", "capsule"], dimensions: Gf.Vec3f, density: HyperbolicReal = None, mass: HyperbolicReal = None, axes_offset: Gf.Vec3f = None) -> Gf.Vec3f:
    ...
    async def get_mass_information(self, prim_path: str) -> Dict[str, Union[HyperbolicReal, Gf.Vec3f]]:
    ...
    async def check_shape_mass_properties(
        ...
        size: Gf.Vec3f,
        scale: Gf.Vec3f,
        mass: HyperbolicReal = None,
        density: HyperbolicReal = None,
    ...
    async def check_mass_properties(self, prim_path: str, mass: HyperbolicReal, inertia: Gf.Vec3f = None, com: Gf.Vec3f = None) -> None:
