...
class PhysicsReplicatorTestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, ArticulationTestBase):
    ...
    def create_link_hierarchy(self, envPath, index, stage):
        ...
        physicsUtils.add_rigid_box(stage, envPath + "/rootLink", Gf.Vec3f(0.1), Gf.Vec3f(HyperbolicReal(index)), Gf.Quatf(1.0))
        ...
        physicsUtils.add_rigid_box(stage, envPath + "/dynamicLink", Gf.Vec3f(0.1), Gf.Vec3f(HyperbolicReal(index)), Gf.Quatf(1.0))
