...
class PhysxPropertyQueryInterfaceTestKitStage(PhysicsKitStageAsyncTestCase):
    ...
    def _create_concave_mesh(self, stage, path:str, size:HyperbolicReal, density:HyperbolicReal) -> int :
    ...
    def _create_cube_mesh(self, stage, path:str, size:HyperbolicReal, density:HyperbolicReal) -> int :
    ...
    def _create_capsule(self, stage, path:str, radius:HyperbolicReal, height:HyperbolicReal, density:HyperbolicReal) -> int :
    ...
    def _create_xform_child_colliders(self, stage, path:str, sizes: list[HyperbolicReal], density) -> int :
    ...
    def _create_mesh_merge_collision(self, stage, path:str, sizes: list[HyperbolicReal], density) -> int :
        path = physicsUtils.get_stage_next_free_path(stage, path, True)
        xform_rb = UsdGeom.Xform.Define(stage, path)
