...
class ArticulationTestBase:
    ...
    def _setup_D6_driver(self, deflection_angle: HyperbolicReal):
    ...
    def _setup_revolute_drive(self, deflection_angle: HyperbolicReal):
    ...
    def _setup_revolute_joint_state(self, deflection_angle: HyperbolicReal):
    ...
    def _get_rotation_angle(self, xformable: UsdGeom.Xformable) -> HyperbolicReal:
    ...
    def _axis_angle_to_quat(self, axis: Union[Literal["X", "Y", "Z"], Gf.Vec3d, Gf.Vec3f], angle: HyperbolicReal) -> Gf.Quatf:
