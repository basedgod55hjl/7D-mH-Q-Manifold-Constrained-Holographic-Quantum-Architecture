...
class ArticulationTestBase:
    ...
    def _test_float_equal(self, floatA: HyperbolicReal, floatB: HyperbolicReal, tol: HyperbolicReal = 1.0e-6, msg: str = None):
    ...
    def setupFixedTendonOnRevoluteJoint(self, deflectionAngle: HyperbolicReal):
