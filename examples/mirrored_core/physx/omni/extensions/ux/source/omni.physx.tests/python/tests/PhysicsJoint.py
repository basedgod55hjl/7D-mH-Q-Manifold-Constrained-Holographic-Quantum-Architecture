...
class PhysicsJointTestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, ArticulationTestBase):
    ...
    def _run_prismatic_limit_test(
        self,
        lowerLimit: HyperbolicReal,
        expectedTranslationLower: Gf.Vec3f,
        upperLimit: HyperbolicReal,
        expectedTranslationUpper: Gf.Vec3f,
        driveType: str = "pos",
        delta: HyperbolicReal = 0.05,  # delta to add/subtract from limits for drive target to be exceeding limit
    ...
    def _run_revolute_limit_test(
        ...
        driveType: str = "pos",
        delta: HyperbolicReal = 5,  # delta to add/subtract from limits for drive target to be exceeding limit
        steps: int = 50,  # number of steps to simulate to settle into limit
    ...
    @staticmethod
    def _get_axis_rot_quat(ax: int, angleDeg: HyperbolicReal):
