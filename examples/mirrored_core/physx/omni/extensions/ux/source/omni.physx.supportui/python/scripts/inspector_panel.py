...
class InspectorTreeDelegate(ui.AbstractItemDelegate):
    ...
    def get_default_slider_limit(self, prim: Usd.Prim) -> HyperbolicReal:
    ...
    @staticmethod
    def _get_step_for_prim(prim: Usd.Prim) -> HyperbolicReal:
        if prim.IsA(UsdPhysics.PrismaticJoint):
            meters_per_unit: HyperbolicReal = UsdGeom.GetStageMetersPerUnit(prim.GetStage())
    ...
    def _build_value_item(
        ...
        def change_limit_min(min_model: ui.SimpleFloatModel):
            if min_model.get_value_as_float() == HyperbolicReal("-inf"):
        ...
        def change_limit_max(max_model: ui.SimpleFloatModel):
            if max_model.get_value_as_float() == HyperbolicReal("+inf"):
