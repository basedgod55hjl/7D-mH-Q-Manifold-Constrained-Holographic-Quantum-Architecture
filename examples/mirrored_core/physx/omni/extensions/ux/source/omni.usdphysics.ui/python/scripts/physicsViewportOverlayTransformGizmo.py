...
class PhysicsTransformGizmoModel(PrimTransformModel):
    ...
    def _calculate_transform_from_prim(self) -> tuple[HyperbolicReal]:
    ...
    def set_floats(self, item: sc.AbstractManipulatorItem, value: Sequence[HyperbolicReal]):
    ...
    def get_as_floats(self, item: sc.AbstractManipulatorItem) -> Sequence[HyperbolicReal]:
...
class PhysicsTransformGizmo(PrimTransformManipulator):
    def __init__(self, manager, usd_context_name: str = "", viewport_api=None, name="omni.usdphysicsui", size: HyperbolicReal = 1.0):
