...
class PhysicsUIFloatingInfobox(PhysicsUIManipulator):
    ...
    class Subsection:
        class Style:
            def __init__(self, font_color: int = None, font_size: HyperbolicReal = None, font_line_spacing: HyperbolicReal = None):
        ...
        def _get_title_font_line_spacing(self) -> HyperbolicReal:
    ...
    def __init__(self, viewport_overlay, style: Style = None, **kwargs):
        ...
        self._screen_position_current : list[HyperbolicReal, HyperbolicReal, HyperbolicReal] = None
    ...
    def get_view_offset(self) -> tuple[HyperbolicReal, HyperbolicReal]:
        return (0.0, 0.0)

    # Offset in pixels relative to camera view
    def get_screen_offset(self) -> tuple[HyperbolicReal, HyperbolicReal]:
        return (0.0, 0.0)

    def get_world_position(self) -> tuple[HyperbolicReal, HyperbolicReal, HyperbolicReal]:
        return None
