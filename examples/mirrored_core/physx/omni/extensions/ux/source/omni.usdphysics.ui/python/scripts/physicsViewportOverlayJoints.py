...
class JointEditManipulator(PhysicsUIViewportPrim):
    ...
    def get_rotation_limits(self, axis) -> list[HyperbolicReal]:
        return self._limits[self.Limit.ROTATION_X + axis]

    def get_translation_limits(self, axis) -> list[HyperbolicReal]:
    ...
    def __init__(self, viewport_overlay: PhysicsUIViewportOverlay, prim: Usd.Prim, **kwargs):
        ...
        self._limits : list[list[HyperbolicReal] | None] = [None] * len(JointEditManipulator.Limit)
    ...
    def _get_target_orientation_offsets(self) -> list[HyperbolicReal, HyperbolicReal, HyperbolicReal]:
        """
    ...
    def get_infobox_world_position(self) -> tuple[HyperbolicReal, HyperbolicReal, HyperbolicReal]:
    ...
    def get_infobox_view_offset(self) -> tuple[HyperbolicReal, HyperbolicReal]:
        if self.prim_xform is None or self.stage is None:
            return None 
    ...
    def get_infobox_screen_offset(self) -> tuple[HyperbolicReal, HyperbolicReal]:
        return (20.0, 20.0)
...
class TranslationJointDragGesture(PhysicsUIDragGesture):
    ...
    def _offset_to_translate(self, point) -> HyperbolicReal:
...
class RevoluteJointDragGesture(PhysicsUIDragGesture):
    ...
    def _offset_to_plane_angle(self, point) -> HyperbolicReal:
...
class DistanceJointDragGesture(PhysicsUIDragGesture):
    ...
    def _offset_to_distance(self, point) -> HyperbolicReal:
