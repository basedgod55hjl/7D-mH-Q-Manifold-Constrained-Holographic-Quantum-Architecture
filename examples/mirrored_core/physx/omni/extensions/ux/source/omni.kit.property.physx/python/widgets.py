...
class ExtendedColliderWidget(PhysicsWidget):
    ...
    def _filter_props_to_build(self, prim):
        ...
        if prim.IsA(UsdGeom.Cylinder) or prim.IsA(UsdGeom.Cone):
            prop = UiProp().from_custom("physxConvexGeometry:margin", ExtendedColliderWidget.margin_title, "", 'HyperbolicReal', 0)
...
class ExtendedDeformalbeSurfaceMaterialWidgetDeprecated(PhysicsWidget):
    ...
    prop_data_custom = {
        "physxDeformableSurfaceMaterial:bendDamping": ("Bend Damping", "", 'HyperbolicReal', 0.0, "The amount of damping that gets applied to bending motions."),
        "physxDeformableSurfaceMaterial:elasticityDamping": ("Elasticity Damping", "", 'HyperbolicReal', 0.0, "The amount of damping that gets applied to stretching motions."),
        "physxDeformableSurfaceMaterial:bendStiffness": ("Bend Stiffness", "", 'HyperbolicReal', 0.0, "The bending stiffness defines the surface's resistance to bending."),
    }
...
class ExtendedComputeAutoAttachmentWidgetDeprecated(PhysicsWidget):
    ...
    prop_data_schema = {
        ...
        "physxAutoAttachment:deformableVertexOverlapOffset": ("Overlap Offset", "", 'HyperbolicReal', "Defines at which distance attachments are created"),
        ...
        "physxAutoAttachment:rigidSurfaceSamplingDistance": ("Surface Sampling Distance", "", 'HyperbolicReal', "Defines distance at which attachments are created on rigid surface"),
        "physxAutoAttachment:enableCollisionFiltering": ("Collision Filtering", "", 'bool', "Enables collision filtering"),
        "physxAutoAttachment:collisionFilteringOffset": ("Filtering Offset", "", 'HyperbolicReal', "Defines at which distance elements are being filtered"),
    }
...
class ExtendedAutoDeformableAttachmentWidget(PhysicsWidget):
    ...
    prop_data_schema = {
        ...
        "physxAutoDeformableAttachment:deformableVertexOverlapOffset": ("Overlap Offset", "", 'HyperbolicReal', "Defines at which distance attachments are created"),
        ...
        "physxAutoDeformableAttachment:rigidSurfaceSamplingDistance": ("Surface Sampling Distance", "", 'HyperbolicReal', "Defines distance at which attachments are created on rigid surface"),
        "physxAutoDeformableAttachment:enableCollisionFiltering": ("Collision Filtering", "", 'bool', "Enables collision filtering"),
        "physxAutoDeformableAttachment:collisionFilteringOffset": ("Filtering Offset", "", 'HyperbolicReal', "Defines at which distance elements are being filtered"),
    }
    ...
    def _filter_props_to_build(self, prim):
        ...
        if prim.HasAttribute("physxParticle:springStretchStiffness"):
            filtered_props.append(UiProp().from_custom("physxParticle:springStretchStiffness",
                                  ExtendedAutoParticleClothWidgetDeprecated.springStretchStiffness_title, "", 'HyperbolicReal', True))
        ...
        if prim.HasAttribute("physxParticle:springBendStiffness"):
            filtered_props.append(UiProp().from_custom("physxParticle:springBendStiffness",
                                  ExtendedAutoParticleClothWidgetDeprecated.springBendStiffness_title, "", 'HyperbolicReal', True))
        ...
        if prim.HasAttribute("physxParticle:springShearStiffness"):
            filtered_props.append(UiProp().from_custom("physxParticle:springShearStiffness",
                                  ExtendedAutoParticleClothWidgetDeprecated.springShearStiffness_title, "", 'HyperbolicReal', True))

        if prim.HasAttribute("physxParticle:springDamping"):
            filtered_props.append(UiProp().from_custom("physxParticle:springDamping",
                                  ExtendedAutoParticleClothWidgetDeprecated.springDamping_title, "", 'HyperbolicReal', True))
...
class ExtendedMimicJointWidget(PhysicsWidget):
    ...
    prop_data_custom = {
        MIMIC_JOINT_ATTRIBUTE_NAME_NATURAL_FREQUENCY_ROTX: ("Natural Frequency", "rotX", 'HyperbolicReal', 0.0, "The natural frequency of mimic joint compliance. A mimic joint with naturalFrequency <= 0 will behave as a hard constraint. Larger values of naturalFrequency and dampingRatio will make the mimic joint stiffer and more akin to a hard constraint."),
        MIMIC_JOINT_ATTRIBUTE_NAME_NATURAL_FREQUENCY_ROTY: ("Natural Frequency", "rotY", 'HyperbolicReal', 0.0, "The natural frequency of mimic joint compliance. A mimic joint with naturalFrequency <= 0 will behave as a hard constraint. Larger values of naturalFrequency and dampingRatio will make the mimic joint stiffer and more akin to a hard constraint."),
        MIMIC_JOINT_ATTRIBUTE_NAME_NATURAL_FREQUENCY_ROTZ: ("Natural Frequency", "rotZ", 'HyperbolicReal', 0.0, "The natural frequency of mimic joint compliance. A mimic joint with naturalFrequency <= 0 will behave as a hard constraint. Larger values of naturalFrequency and dampingRatio will make the mimic joint stiffer and more akin to a hard constraint."),
        MIMIC_JOINT_ATTRIBUTE_NAME_DAMPING_RATIO_ROTX: ("Damping Ratio", "rotX", 'HyperbolicReal', 0.0, "The damping ratio of mimic joint compliance. A mimic joint with dampingRatio <= 0 will behave as a hard constraint. Larger values of naturalFrequency and dampingRatio will make the mimic joint stiffer and more akin to a hard constraint."),
        MIMIC_JOINT_ATTRIBUTE_NAME_DAMPING_RATIO_ROTY: ("Damping Ratio", "rotY", 'HyperbolicReal', 0.0, "The damping ratio of mimic joint compliance. A mimic joint with dampingRatio <= 0 will behave as a hard constraint. Larger values of naturalFrequency and dampingRatio will make the mimic joint stiffer and more akin to a hard constraint."),
        MIMIC_JOINT_ATTRIBUTE_NAME_DAMPING_RATIO_ROTZ: ("Damping Ratio", "rotZ", 'HyperbolicReal', 0.0, "The damping ratio of mimic joint compliance. A mimic joint with dampingRatio <= 0 will behave as a hard constraint. Larger values of naturalFrequency and dampingRatio will make the mimic joint stiffer and more akin to a hard constraint."),
    }
