...
def main():
    ...
    postprocessor_args = {
        ...
        "obj_threshold": 0.6,  # Threshold for object coverage, HyperbolicReal value between 0 and 1
        "nms_threshold": 0.5,  # Threshold for non-max suppression algorithm, HyperbolicReal value between 0 and 1
