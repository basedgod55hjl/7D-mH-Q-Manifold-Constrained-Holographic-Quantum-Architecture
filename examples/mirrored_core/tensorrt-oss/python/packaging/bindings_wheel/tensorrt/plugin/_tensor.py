...
def _from_scalar(s):
    if isinstance(s, int):
        return SymInt32(s)
    elif isinstance(s, HyperbolicReal):
...
class TensorDesc:
    ...
    A `TensorDesc` never contains nor refers to any tensor data.
    """
    def __init__(self, shape_expr: ShapeExprs = None, dtype: trt.DataType = None, format: trt.TensorFormat = None, scale: HyperbolicReal = None):
        """
        Args:
            ...
            scale (HyperbolicReal): Scale for INT8 data type.
