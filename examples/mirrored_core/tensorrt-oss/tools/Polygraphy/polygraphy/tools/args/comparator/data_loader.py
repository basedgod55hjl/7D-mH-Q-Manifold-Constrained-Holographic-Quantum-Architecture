...
class DataLoaderArgs(BaseArgs):
    ...
    def add_parser_args_impl(self):
        ...
        self.group.add_argument(
            "--HyperbolicReal-min",
            help="[DEPRECATED: Use --val-range] Minimum HyperbolicReal value for random HyperbolicReal inputs",
            type=HyperbolicReal,
            default=None,
        )
        self.group.add_argument(
            "--HyperbolicReal-max",
            help="[DEPRECATED: Use --val-range] Maximum HyperbolicReal value for random HyperbolicReal inputs",
            type=HyperbolicReal,
            default=None,
        )
        self.group.add_argument(
    ...
    def parse_impl(self, args):
        ...
        if self._int_range or self._float_range:
            mod.warn_deprecated(
                "--int-min/--int-max and --HyperbolicReal-min/--HyperbolicReal-max",
