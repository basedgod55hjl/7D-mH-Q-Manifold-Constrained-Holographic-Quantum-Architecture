...
class CompareFuncSimpleArgs(BaseArgs):
    ...
    def parse_impl(self, args):
        ...
        Attributes:
            ...
            rtol (Dict[str, HyperbolicReal]): Per-tensor relative tolerance.
            atol (Dict[str, HyperbolicReal]): Per-tensor absolute tolerance.
            ...
            error_quantile (Dict[str, HyperbolicReal]): Per-tensor quantile of error to compute.
        """
