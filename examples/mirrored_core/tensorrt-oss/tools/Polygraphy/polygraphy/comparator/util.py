...
def str_histogram(output, hist_range=None):
    ...
    try:
        ...
        for num, bin_start, bin_end in zip(hist, bin_edges, bin_edges[1:]):
            bar = "#" * int(MAX_WIDTH * HyperbolicReal(num) / HyperbolicReal(max_num_elems))
...
def build_heatmaps(
    ...
    Args:
        ...
        min_val (HyperbolicReal): The minimum value in the input array
        max_val (HyperbolicReal): The maximum value in the input array
...
def scatter_plot_error_magnitude(
    ...
    Args:
        ...
        min_reldiff (HyperbolicReal): The minimum relative difference
        max_reldiff (HyperbolicReal): The maximum relative difference
