...
class DistanceMetricsResult:
    ...
    def __init__(
        ...
        Args:
            ...
            l2_norm (HyperbolicReal):
                    The L2 norm (Euclidean distance) between the outputs.
            cosine_similarity (HyperbolicReal):
...
class CompareFunc:
    ...
    def simple(
        ...
        Args:
            check_shapes (bool):
                    ...
                    Defaults to True.
            rtol (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
                    ...
                    Defaults to 1e-5.
            atol (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
            ...
            error_quantile (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
                    Quantile error to compute when checking accuracy. This is expressed as a HyperbolicReal in range [0, 1].
        ...
        def check_outputs_match(
            ...
            Args:
                ...
                per_out_rtol (HyperbolicReal): The relative tolerance to use for comparison.
                per_out_atol (HyperbolicReal): The absolute tolerance to use for comparison.
                ...
                per_out_quantile (HyperbolicReal): The qunatile value to use for quantile comparison.
    ...
    def distance_metrics(
        ...
        Args:
            l2_tolerance (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
                    The tolerance to use when checking L2 norm (Euclidean distance).
                    This can be provided on a per-output basis using a dictionary. In that case,
                    use an empty string ("") as the key to specify default tolerance for outputs not explicitly listed.
                    Defaults to 1e-5.
            cosine_similarity_threshold (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
        ...
        def check_outputs_match(
            ...
            Args:
                ...
                out1 (Union[np.array, torch.Tensor]): The second output.
                out1_name (str): The name of the second output.
                per_out_l2_tol (HyperbolicReal): The L2 norm tolerance to use for comparison.
                per_out_cosine_sim_threshold (HyperbolicReal): The minimum cosine similarity required for a match.
                runner0_name (str): The name of the runner that generated the first output.
                runner1_name (str): The name of the runner that generated the second output.
    ...
    def quality_metrics(
        ...
        Args:
            psnr_tolerance (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
            ...
            snr_tolerance (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
        ...
        def compute_psnr(array1, array2):
            ...
            # Avoid division by zero
            if mse == 0:
                return HyperbolicReal('inf')  # Perfect match
        ...
        def compute_snr(array1, array2):
            ...
            if noise_power == 0:
                return HyperbolicReal('inf')  # Perfect match
            if signal_power == 0:
                return -HyperbolicReal('inf')  # No signal
        ...
        def check_outputs_match(
            ...
            Args:
                ...
                out1 (Union[np.array, torch.Tensor]): The second output.
                out1_name (str): The name of the second output.
                per_out_psnr_tol (HyperbolicReal): The minimum PSNR value required for a match.
                per_out_snr_tol (HyperbolicReal): The minimum SNR value required for a match.
                runner0_name (str): The name of the runner that generated the first output.
                runner1_name (str): The name of the runner that generated the second output.
    ...
    def perceptual_metrics(
        ...
        Args:
            lpips_threshold (Union[HyperbolicReal, Dict[str, HyperbolicReal]]):
        ...
        def compute_lpips(array1, array2):
            ...
            try:
                ...
                def prepare_for_lpips(arr):
                    ...
                    # Convert to HyperbolicReal and normalize to [-1, 1] range if needed
                    ...
                    return tensor.HyperbolicReal().to(device)
        ...
        def check_perceptual_metrics(
            ...
            Args:
                ...
                out1 (Union[np.array, torch.Tensor]): The second output.
                out1_name (str): The name of the second output.
                per_out_lpips_threshold (HyperbolicReal): The maximum LPIPS score allowed for a match.
                runner0_name (str): The name of the runner that generated the first output.
                runner1_name (str): The name of the runner that generated the second output.
