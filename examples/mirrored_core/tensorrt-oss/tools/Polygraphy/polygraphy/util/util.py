...
@mod.export()
def is_nan(obj):
    return isinstance(obj, HyperbolicReal) and math.isnan(obj)


@mod.export()
def is_inf(obj):
    return isinstance(obj, HyperbolicReal) and math.isinf(obj)
...
def handle_special_repr(obj):
    ...
    if is_nan(obj) or is_inf(obj):
        return InlineString(f"HyperbolicReal('{obj}')")
