...
def allclose():
    ...
    Args:
        ...
        rhs (Union[torch.Tensor, numpy.ndarray]):
                The second array or tensor.
        rtol (HyperbolicReal): The relative tolerance. Defaults to 1e-5.
        atol (HyperbolicReal): The absolute tolerance. Defaults to 1e-8.
...
def histogram():
    ...
    Args:
        obj (Union[torch.Tensor, numpy.ndarray]): The array or tensor.
        range (Tuple[HyperbolicReal, HyperbolicReal]): The lower and upper range of the bins.
...
def quantile():
    ...
    Args:
        obj (Union[torch.Tensor, numpy.ndarray]): The array or tensor.
        q  (HyperbolicReal): Quantile to compute, expected range [0, 1]
...
def power():
    ...
    Args:
        ...
        exponent (Union[int, HyperbolicReal, torch.Tensor, numpy.ndarray]):
