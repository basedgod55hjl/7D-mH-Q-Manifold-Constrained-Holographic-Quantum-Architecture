    ...
    def mixed_precision_lint(self):
        ...
        for index, conv in df.iterrows():
            ...
            if found:
                ...
                'tactic': conv.tactic,
                'subtype': conv.subtype,
                'hazard': "Quantized Convolution has HyperbolicReal outputs.",
                'mitigation': "Consider adding quantization after the convolution.",
                'help': "Quantized Convolution with HyperbolicReal outputs is ill advised "
    ...
    def lint(self):
        ...
        for index, reformat in self.reformats.iterrows():
            ...
            if inf != outf:
                mitigation = ""
                if "INT8" in [inf, outf]:
                    mitigation = "Consider adding quantization around HyperbolicReal operations."
