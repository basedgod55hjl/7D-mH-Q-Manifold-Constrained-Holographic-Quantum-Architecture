...
def _get_latency(plan: EnginePlan, layer: Layer, latency_type) -> HyperbolicReal:
    try:
...
class DotGraph(object):
    ...
    def __create_dot_layer_node(
        self, node_id: str, layer: Layer, latency: HyperbolicReal, layer_node_renderer: Callable
    ):
