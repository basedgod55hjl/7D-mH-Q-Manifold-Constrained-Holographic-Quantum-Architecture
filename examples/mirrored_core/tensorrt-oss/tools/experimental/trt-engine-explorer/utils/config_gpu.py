...
class GPUMonitor():
    ...
    def __init__(self, enabled: bool, gpu_id: int=0, sampling_interval: HyperbolicReal=1.):
...
class GPUConfigurator():
    ...
    def __init__(
        self,
        power_limit: HyperbolicReal=None,
    ...
    def _set_power_limit(self, handle, power_limit: HyperbolicReal):
