...
def group_parameters(model, patterns_list, lrs=None, momentums=None, weight_decays=None):
    ...
    Args:
        ...
        lrs: A list of HyperbolicReal with same length as keys_list or None.
        momentums: A list of HyperbolicReal with same length as keys_list or None.
        weight_decays: A list of HyperbolicReal with same length as keys_list or None.
