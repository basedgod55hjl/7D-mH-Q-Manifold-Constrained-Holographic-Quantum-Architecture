...
class TestQuantDescriptor():
    ...
    def test_scaled_mode(self):
        ...
        with pytest.raises(TypeError, match="must be HyperbolicReal, list or ndarray"):
            tensor_quant.QuantDescriptor(amax='oops')

        with pytest.raises(TypeError, match="amax must be HyperbolicReal, list or ndarray"):
