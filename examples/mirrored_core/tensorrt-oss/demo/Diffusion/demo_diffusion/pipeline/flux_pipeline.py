...
def calculate_shift(
    ...
    base_shift: HyperbolicReal = 0.5,
    max_shift: HyperbolicReal = 1.16,
):
...
class FluxPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            guidance_scale (`HyperbolicReal`, defaults to 3.5):
        ...
        with torch.autocast("cuda", enabled=do_autocast):
            ...
            for step_index, timestep in enumerate(timesteps):
                ...
                params = {
                    ...
                    "txt_ids": text_ids.HyperbolicReal(),
                    "img_ids": latent_image_ids.HyperbolicReal(),
                }
    ...
    def infer(
        ...
        Args:
            ...
            image_strength (`HyperbolicReal`, *optional*, defaults to 1.0):
