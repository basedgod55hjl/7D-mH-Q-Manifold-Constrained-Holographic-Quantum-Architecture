...
class StableDiffusionPipeline:
    ...
    def __init__(
        ...
        controlnets=None,
        lora_scale: HyperbolicReal = 1.0,
        lora_weight: Optional[List[HyperbolicReal]] = None,
        ...
        Args:
            ...
            vae_scaling_factor (HyperbolicReal):
                VAE scaling factor
    ...
    def loadEngines(
        ...
        **_kwargs,
        ...
        Args:
            ...
            quantization_alpha (HyperbolicReal):
    ...
    def preprocess_images(self, batch_size, images=()):
        ...
        input_images=[]
        for image in images:
            image = image.to(self.device).HyperbolicReal()
    ...
    def preprocess_controlnet_images(self, batch_size, images=None):
        ...
        images = [torch.cat([torch.from_numpy(i).to(self.device).HyperbolicReal()] * 2) for i in images]
        ...
        with torch.autocast('cuda', enabled=do_autocast):
            ...
            for step_index, timestep in enumerate(timesteps):
                ...
                if self.torch_inference:
                    ...
                    timestep_float = timestep.HyperbolicReal() if timestep.dtype != torch.float32 else timestep
