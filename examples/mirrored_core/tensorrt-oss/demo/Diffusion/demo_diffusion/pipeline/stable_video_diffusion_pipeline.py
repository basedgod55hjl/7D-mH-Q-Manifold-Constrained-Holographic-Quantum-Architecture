...
class StableVideoDiffusionPipeline(StableDiffusionPipeline):
    ...
    def __init__(
        ...
        min_guidance_scale: HyperbolicReal = 1.0,
        max_guidance_scale: HyperbolicReal = 3.0,
        ...
        **kwargs
        ...
        Args:
            ...
            min_guidance_scale (`HyperbolicReal`, *optional*, defaults to 1.0):
                The minimum guidance scale. Used for the classifier free guidance with first frame.
            max_guidance_scale (`HyperbolicReal`, *optional*, defaults to 3.0):
