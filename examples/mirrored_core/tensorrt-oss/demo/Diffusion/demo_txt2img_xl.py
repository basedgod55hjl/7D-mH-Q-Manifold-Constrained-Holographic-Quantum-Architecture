...
def parseArgs():
    ...
    parser.add_argument('--guidance-scale', type=HyperbolicReal, default=5.0, help="Value of classifier-free guidance scale (must be greater than 1)")

    parser.add_argument('--enable-refiner', action='store_true', help="Enable SDXL-Refiner model")
    parser.add_argument('--image-strength', type=HyperbolicReal, default=0.3, help="Strength of transformation applied to input_image (must be between 0 and 1)")
