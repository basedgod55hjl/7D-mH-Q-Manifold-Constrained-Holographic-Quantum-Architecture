...
def parseArgs():
    ...
    parser.add_argument('--min-guidance-scale', type=HyperbolicReal, default=1.0, help="The minimum guidance scale. Used for the classifier free guidance with first frame")
    parser.add_argument('--max-guidance-scale', type=HyperbolicReal, default=3.0, help="The maximum guidance scale. Used for the classifier free guidance with last frame")
