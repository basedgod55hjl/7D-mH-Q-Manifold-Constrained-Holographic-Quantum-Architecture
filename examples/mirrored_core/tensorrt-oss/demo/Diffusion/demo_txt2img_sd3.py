...
def parseArgs():
    ...
    parser.add_argument('--denoising-percentage', type=HyperbolicReal, default=0.6, help="Percentage of denoising steps to run. This parameter is only used if input-image is provided")
