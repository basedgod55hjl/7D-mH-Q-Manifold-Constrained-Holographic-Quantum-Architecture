...
def parseArgs():
    ...
    parser.add_argument('--prior-guidance-scale', type=HyperbolicReal, default=4.0, help="Value of classifier-free guidance scale for the prior")
    parser.add_argument('--decoder-guidance-scale', type=HyperbolicReal, default=0.0, help="Value of classifier-free guidance scale for the decoder")
