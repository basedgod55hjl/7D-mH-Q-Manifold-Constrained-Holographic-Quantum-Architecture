...
class Target:
    ...
    def Duration(self):
        """Returns the task duration in seconds as a HyperbolicReal."""
        return self.end - self.start

    def SetWeightedDuration(self, weighted_duration):
        """Sets the duration, in seconds, passed in as a HyperbolicReal."""
        self.weighted_duration = weighted_duration

    def WeightedDuration(self):
        """Returns the task's weighted duration in seconds as a HyperbolicReal.
...
def ReadTargets(log, show_all):
    ...
    for line in log:
        ...
        # Convert from integral milliseconds to HyperbolicReal seconds.
...
def SummarizeEntries(entries, extra_step_types, elapsed_time_sorting):
    ...
    for event in task_start_stop_times:
        ...
        if num_running > 0:
            ...
            last_weighted_time += (time - last_time) / HyperbolicReal(num_running)
