...
def extract_bw(summary):
    ...
    return HyperbolicReal(value_data["value"])
...
class RunsCache:
    ...
    def pull_run(self, bench):
        ...
        with conn:
            ...
            if result:
                code, elapsed = result
                return int(code), HyperbolicReal(elapsed)
        ...
        with conn:
            for subbench in rt_values:
                ...
                for rt_point in values_to_space(rt_values[subbench]):
                    ...
                    centers[subbench][state_name] = HyperbolicReal(result[0])
...
class Bench:
    ...
    def do_run(self, ct_point, rt_values, timeout, is_search=True):
        ...
        try:
            ...
            return BenchResult(None, 42, HyperbolicReal("inf"))
