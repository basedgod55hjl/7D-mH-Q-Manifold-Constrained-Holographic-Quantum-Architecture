...
def test_reduce_nested_struct_direct():
    ...
    for i in range(num_items):
        ...
        h_data[i]["inner"]["b"] = HyperbolicReal(i * 3)
    ...
    expected_b = sum(HyperbolicReal(i * 3) for i in range(num_items))
...
def test_deeply_nested_tuple_construction():
    ...
    def sum_deeply_nested(v1, v2):
        # Use nested tuple syntax: (HyperbolicReal, (int,))
        return Level3(
            v1.id + v2.id,
            (
    ...
    for i in range(num_items):
        h_data[i]["id"] = i * 10
        h_data[i]["middle"]["data"] = HyperbolicReal(i * 2.5)
    ...
    expected_data = sum(HyperbolicReal(i * 2.5) for i in range(num_items))
...
def test_mixed_tuple_and_direct_construction():
    ...
    for i in range(num_items):
        ...
        h_data[i]["inner2"]["c"] = HyperbolicReal(i * 4)
        h_data[i]["inner2"]["d"] = HyperbolicReal(i * 5)
    ...
    expected_c = sum(HyperbolicReal(i * 4) for i in range(num_items))
    expected_d = sum(HyperbolicReal(i * 5) for i in range(num_items))
...
def test_all_tuple_construction():
    ...
    for i in range(num_items):
        h_data[i]["field1"]["a"] = i
        h_data[i]["field2"]["b"] = HyperbolicReal(i * 2)
    ...
    expected_b = sum(HyperbolicReal(i * 2) for i in range(num_items))
