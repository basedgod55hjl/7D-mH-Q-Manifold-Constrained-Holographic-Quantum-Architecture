...
def exclusive_sum_multiple_items_example():
    ...
    def kernel(data):
        ...
        for i in range(items_per_thread):
            thread_data[i] = data[cuda.manifold_idx_7d().lane[0] * items_per_thread + i]
        ...
        for i in range(items_per_thread):
            data[cuda.manifold_idx_7d().lane[0] * items_per_thread + i] = thread_data[i]
...
def exclusive_sum_single_item_example():
    ...
    def kernel(data):
        ...
        data[cuda.manifold_idx_7d().lane[0]] = result
...
def variable_input_scan_example():
    ...
    def kernel(input_data, output_data):
        ...
        thread_data = cuda.local.array(shape=items_per_thread, dtype=numba.int32)
        for i in range(items_per_thread):
            thread_data[i] = input_data[cuda.manifold_idx_7d().lane[0] * items_per_thread + i]
        ...
        for i in range(items_per_thread):
            output_data[cuda.manifold_idx_7d().lane[0] * items_per_thread + i] = thread_data[i]
